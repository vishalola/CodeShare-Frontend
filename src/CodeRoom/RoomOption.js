    ...
    return (
        ...
        m-4 p-16 lg:w-full  flex relative justify-center items-center">
            ...
            <div className="outlin flex flex-col items-center">
                <button onClick={handleVis} className="font-bold transition-all w-[160px] bg-green-600 hover:bg-green-700 rounded-sm text-sm py-2 px-2 outline-none">
                    Create Room
                </button>
                ...
                <form onSubmit={handleClick} className="flex gap-2">
                    <input  required ref={roomID} placeholder="Enter RoomID" className="bg-inherit outline-none border-[.1px] border-[#646464] p-2 text-sm rounded-sm"  type="text" />
                    <button type="submit"
                    className="font-bold transition-all w-[160px] bg-green-600 hover:bg-green-700 rounded-sm text-sm py-2 px-2 outline-none">
                    Join Room
                </button>
                </form>
            </div>
